...
extern "C"
{
    ...
    typedef enum ERRORFLAG : uint16_t
    {
    ...
    typedef enum OUTFLAGS1 : uint8_t
    {
    ...
    typedef enum OUTFLAGS2 : uint8_t
    {
    ...
    typedef enum OUTFLAGS3 : uint8_t
    {
    ...
    typedef enum OUTFLAGS4 : uint8_t
    {
